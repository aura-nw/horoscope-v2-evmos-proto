...
export const evmosProtoRegistry = [...evmosErc20V1TxRegistry.registry, ...evmosInflationV1TxRegistry.registry, ...evmosRevenueV1TxRegistry.registry, ...evmosVestingV2TxRegistry.registry];
export const getSigningEvmosClientOptions = ({ defaultTypes = defaultRegistryTypes } = {}) => {
...
export const getSigningEvmosClient = async ({ rpcEndpoint, signer, defaultTypes = defaultRegistryTypes }) => {
    const { registry, aminoTypes } = getSigningEvmosClientOptions({
        defaultTypes
    });
