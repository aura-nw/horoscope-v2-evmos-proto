...
export const Pair = {
  ...
  fromJSON(object: any): Pair {
    return {
      ...
      priceTicksize: isSet(object.priceTicksize) ? String(object.priceTicksize) : undefined,
      quantityTicksize: isSet(object.quantityTicksize) ? String(object.quantityTicksize) : undefined
    };
  },
  toJSON(message: Pair): unknown {
    ...
    message.priceTicksize !== undefined && (obj.priceTicksize = message.priceTicksize);
    message.quantityTicksize !== undefined && (obj.quantityTicksize = message.quantityTicksize);
    return obj;
  },
