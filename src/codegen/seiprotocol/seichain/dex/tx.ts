...
export const MsgRegisterPairs = {
  ...
  fromJSON(object: any): MsgRegisterPairs {
    return {
      creator: isSet(object.creator) ? String(object.creator) : "",
      batchcontractpair: Array.isArray(object?.batchcontractpair) ? object.batchcontractpair.map((e: any) => BatchContractPair.fromJSON(e)) : []
    };
  },
...
export const MsgUpdatePriceTickSize = {
  ...
  fromJSON(object: any): MsgUpdatePriceTickSize {
    return {
      creator: isSet(object.creator) ? String(object.creator) : "",
      tickSizeList: Array.isArray(object?.tickSizeList) ? object.tickSizeList.map((e: any) => TickSize.fromJSON(e)) : []
    };
  },
