...
export const PriceSnapshot = {
  ...
  fromJSON(object: any): PriceSnapshot {
    return {
      ...
      priceSnapshotItems: Array.isArray(object?.priceSnapshotItems) ? object.priceSnapshotItems.map((e: any) => PriceSnapshotItem.fromJSON(e)) : []
    };
  },
  ...
  fromAmino(object: PriceSnapshotAmino): PriceSnapshot {
    const message = createBasePriceSnapshot();
    if (object.snapshotTimestamp !== undefined && object.snapshotTimestamp !== null) {
      message.snapshotTimestamp = Long.fromString(object.snapshotTimestamp);
    }
