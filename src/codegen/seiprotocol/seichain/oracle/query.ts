...
export const QueryExchangeRatesResponse = {
  ...
  fromJSON(object: any): QueryExchangeRatesResponse {
    return {
      denomOracleExchangeRatePairs: Array.isArray(object?.denomOracleExchangeRatePairs) ? object.denomOracleExchangeRatePairs.map((e: any) => DenomOracleExchangeRatePair.fromJSON(e)) : []
    };
  },
...
export const QueryPriceSnapshotHistoryResponse = {
  ...
  fromJSON(object: any): QueryPriceSnapshotHistoryResponse {
    return {
      priceSnapshots: Array.isArray(object?.priceSnapshots) ? object.priceSnapshots.map((e: any) => PriceSnapshot.fromJSON(e)) : []
    };
  },
...
export const QueryTwapsResponse = {
  ...
  fromJSON(object: any): QueryTwapsResponse {
    return {
      oracleTwaps: Array.isArray(object?.oracleTwaps) ? object.oracleTwaps.map((e: any) => OracleTwap.fromJSON(e)) : []
    };
  },
